...
def show_instructions_sidebar():
    ...
    st.sidebar.info(
        "Welcome to AI Magic - PPT Mastery! This tool helps you generate PowerPoint presentations with AI assistance.\n\n"
        "1. Enter a subject for your presentation in the 'Subject' field.\n"
        "2. Click 'Generate PPT Titles' to get creative and informative presentation titles.\n"
        "3. Enter the final title for your presentation in the 'Enter the final title for the PPT' field.\n"
        "4. Click 'Generate Slide Topics' to get concise and informative slide titles.\n"
        "5. Select slide titles, specify options, and click 'Generate PPT' to generate your presentation.\n"
        "6. Review and download your PowerPoint presentation.\n\n"
        "**Note:** The content is generated by AI. Review and edit as needed. Results may vary."
    )
# Page title
...
Description=st.text_area('Enter description of your mentioned subject in few words.',max_chars=100,height=30)
...
def generate_ppt_titles(subject,Desc):
    if not subject:
    ...
    with st.spinner("Generating PPT titles..."):
        input_prompt = """You are an expert in understanding the subject of what user provide as input.
                          You will receive Subject of PPT and Description of the ppt as input, 
                          and you will have to answer questions based on the input."""
        prompt = f"Generate 5 creative and informative titles for a presentation on the subject of {subject} using " \
                 f"description {Desc}"
        response = model.generate_content([input_prompt,prompt], stream=True)
        response.resolve()
...
if st.button("Generate PPT Titles"):
    generated_ppt_titles = generate_ppt_titles(subject,Description)
...
st.markdown(
    ...
    Please Read out instructions on Top-Left for how to use this website to make ppt  
